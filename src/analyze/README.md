...
| 파일 | 역할 |
|---|---|
| `q1_q2_q3_analysis.ipynb` | 메인 분석 노트북 — 500m 와 200m 두 권역에서 Q1/Q2/Q3 분석 + Plotly 시각화 |
...
셀을 수정하려면 `_build_notebook.py` 의 해당 셀 정의(`cells.append(...)`)를 수정한 뒤:

```bash
python3 src/analyze/_build_notebook.py
```

→ `q1_q2_q3_analysis.ipynb` 가 덮어쓰여진다.
